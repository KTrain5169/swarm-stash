...
import type { MemeRow, UserRow } from '../../features/db.ts';
import { type Card, CARDS } from "../../features/catalog.ts";
...
export const UPLOAD_DIR = path.join(process.env.DATA_DIR || path.join(process.cwd(), 'data'), 'memes');
